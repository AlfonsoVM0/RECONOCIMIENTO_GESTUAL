% MAIN FUNCTION
function OUTPUT = calcula_features_mfcc_plp_online(AccXorig,AccYorig,AccZorig)
...
output_file = './features/online/aux_features_raspi.arff';
...
if fid < 0
  ...
  fprintf(fid,"@attribute activity {stand,sit,walk}\n\n@data\n");
  %fclose (fid2);
